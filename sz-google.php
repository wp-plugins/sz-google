...
define('SZ_PLUGIN_GOOGLE_VERSION','1.8.5');

// The plugin requires some control over connected users before they.
// are loaded from the core. So in the absence is anticipated loading.
