 ...
 */
if (!class_exists('SZGoogleModuleAdminGroups'))
{
	/**
	 ...
	 */
	class SZGoogleModuleAdminGroups extends SZGoogleModuleAdmin
	{
		/**
	 ...
	 */
	$SZ_GOOGLE_ADMIN_GROUPS = new SZGoogleModuleAdminGroups();
}