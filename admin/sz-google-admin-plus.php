 ...
 */
if (!class_exists('SZGoogleModuleAdminPlus'))
{
	/**
	 ...
	 */
	class SZGoogleModuleAdminPlus extends SZGoogleModuleAdmin
	{
		/**
		...
		function moduleAddFields()
		{
			...
			add_settings_field('plus_enable_author',ucwords(__('enable HEAD Author','szgoogleadmin')),array($this,'get_plus_enable_author'),'sz-google-admin-plus.php','sz_google_plus_section');
			...
			add_settings_field('plus_enable_publisher',ucwords(__('enable HEAD Publisher','szgoogleadmin')),array($this,'get_plus_enable_publisher'),'sz-google-admin-plus.php','sz_google_plus_section');
		...
		function get_plus_profile()
		{
			...
			$this->moduleCommonFormDescription(__('enter the code that identifies the profile on google+, get to know the code of a profile just look at the profile link and copy the 21 digit number located on the URL string. For example a profile ID is 106567288702045182616.','szgoogleadmin'));
		}
		...
		{
			$this->moduleCommonFormText('sz_google_options_plus','plus_comments_title','large',__('string HTML for comments title','szgoogleadmin'));
	 ...
	 */
	$SZ_GOOGLE_ADMIN_PLUS = new SZGoogleModuleAdminPlus();
}