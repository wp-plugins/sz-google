 ...
 */
if (!class_exists('SZGoogleModuleAdminPanoramio'))
{
	/**
	 ...
	 */
	class SZGoogleModuleAdminPanoramio extends SZGoogleModuleAdmin
	{
		/**
	 ...
	 */
	$SZ_GOOGLE_ADMIN_PANORAMIO = new SZGoogleModuleAdminPanoramio();
}