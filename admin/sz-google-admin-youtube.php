 ...
 */
if (!class_exists('SZGoogleModuleAdminYoutube'))
{
	/**
	 ...
	 */
	class SZGoogleModuleAdminYoutube extends SZGoogleModuleAdmin
	{
		/**
	 ...
	 */
	$SZ_GOOGLE_ADMIN_YOUTUBE = new SZGoogleModuleAdminYoutube();
}