...
<tr>
	<td colspan="1" class="sz-cell-keys"><label><?php echo ucfirst(__('title','szgoogleadmin')) ?>:</label></td>
...
<tr>
	<td colspan="1" class="sz-cell-keys"><label><?php echo ucfirst(__('date','szgoogleadmin')) ?>:</label></td>
...
<tr>
	<td colspan="1" class="sz-cell-keys"><label><?php echo ucfirst(__('navigation','szgoogleadmin')) ?>:</label></td>
...
<tr>
	<td colspan="1" class="sz-cell-keys"><label><?php echo ucfirst(__('print','szgoogleadmin')) ?>:</label></td>
...
<tr>
	<td colspan="1" class="sz-cell-keys"><label><?php echo ucfirst(__('list','szgoogleadmin')) ?>:</label></td>
...
<tr>
	<td colspan="1" class="sz-cell-keys"><label><?php echo ucfirst(__('time zone','szgoogleadmin')) ?>:</label></td>
