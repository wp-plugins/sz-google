...
<p><table id="SZGoogleWidgetPlusFollowers" class="sz-google-table-widget">
...
<tr>
	<td colspan="1" class="sz-cell-keys"><label for="<?php echo $ID_method ?>"><?php echo ucfirst(__('account','szgoogleadmin')) ?>:</label></td>
...
<tr class="sz-google-switch-specific sz-google-hidden">
	<td colspan="1" class="sz-cell-keys"><label for="<?php echo $ID_specific ?>"><?php echo ucfirst(__('account ID','szgoogleadmin')) ?>:</label></td>
...
<tr>
	...
	<td colspan="1" class="sz-cell-vals"><input id="<?php echo $ID_width ?>" class="sz-google-checks-width" name="<?php echo $NAME_width ?>" type="text" size="5" placeholder="auto" value="<?php echo $VALUE_width ?>"/></td>
...
<tr>
	...
	<td colspan="1" class="sz-cell-vals"><input id="<?php echo $ID_height ?>" class="sz-google-checks-height" name="<?php echo $NAME_height ?>" type="text" size="5" placeholder="auto" value="<?php echo $VALUE_height ?>"/></td>
...
<script type="text/javascript">
	jQuery(document).ready(function() {
		szgoogle_switch_hidden_onload('SZGoogleWidgetPlusFollowers');
		szgoogle_checks_hidden_onload('SZGoogleWidgetPlusFollowers');
	});
</script>