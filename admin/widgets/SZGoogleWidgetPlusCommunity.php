...
<tr>
	<td colspan="1" class="sz-cell-keys"><label for="<?php echo $ID_method ?>"><?php echo ucfirst(__('community','szgoogleadmin')) ?>:</label></td>
...
<tr class="sz-google-switch-specific sz-google-hidden">
	<td colspan="1" class="sz-cell-keys"><label for="<?php echo $ID_specific ?>"><?php echo ucfirst(__('community ID','szgoogleadmin')) ?>:</label></td>
...
<tr>
	<td colspan="1" class="sz-cell-keys"><label><?php echo ucfirst(__('photo','szgoogleadmin')) ?>:</label></td>
...
<tr>
	<td colspan="1" class="sz-cell-keys"><label><?php echo ucfirst(__('owner','szgoogleadmin')) ?>:</label></td>
...
<tr>
	<td colspan="1" class="sz-cell-keys"><label><?php echo ucfirst(__('align','szgoogleadmin')) ?>:</label></td>
