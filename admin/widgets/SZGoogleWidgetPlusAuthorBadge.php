...
<tr class="only-widgets">
	<td colspan="1" class="sz-cell-keys"><label for="<?php echo $ID_mode ?>"><?php echo ucfirst(__('display','szgoogleadmin')) ?>:</label></td>
	<td colspan="2" class="sz-cell-vals">
		<select class="widefat" id="<?php echo $ID_mode ?>" name="<?php echo $NAME_mode ?>">
			<option value="1" <?php echo selected("1",$VALUE_mode) ?>><?php echo __('author post','szgoogleadmin') ?></option>
			<option value="2" <?php echo selected("2",$VALUE_mode) ?>><?php echo __('author post and archive','szgoogleadmin') ?></option>
		</select>
	</td>
</tr>
...
<tr>
	<td colspan="1" class="sz-cell-keys"><label for="<?php echo $ID_link ?>"><?php echo ucfirst(__('link','szgoogleadmin')) ?>:</label></td>
	<td colspan="2" class="sz-cell-vals">
		<select class="widefat" id="<?php echo $ID_link ?>" name="<?php echo $NAME_link ?>">
			<option value="1" <?php echo selected("1",$VALUE_link) ?>><?php echo __('link to google+','szgoogleadmin') ?></option>
			<option value="2" <?php echo selected("2",$VALUE_link) ?>><?php echo __('link to author page','szgoogleadmin') ?></option>
		</select>
	</td>
</tr>
...
<tr>
	...
	<td colspan="2" class="sz-cell-vals">
		<select class="widefat" id="<?php echo $ID_cover ?>" name="<?php echo $NAME_cover ?>">
			<option value="1" <?php echo selected("1",$VALUE_cover) ?>><?php echo __('profile','szgoogleadmin') ?></option>
			<option value="N" <?php echo selected("N",$VALUE_cover) ?>><?php echo __('none','szgoogleadmin') ?></option>
		</select>
	</td>
</tr>
...
<tr>
	...
	<td colspan="2" class="sz-cell-vals">
		<select class="widefat" id="<?php echo $ID_photo ?>" name="<?php echo $NAME_photo ?>">
			<option value="1" <?php echo selected("1",$VALUE_photo) ?>><?php echo __('profile','szgoogleadmin') ?></option>
			<option value="N" <?php echo selected("N",$VALUE_photo) ?>><?php echo __('none','szgoogleadmin') ?></option>
		</select>
	</td>
</tr>
...
<tr>
	<td colspan="1" class="sz-cell-keys"><label for="<?php echo $ID_biography ?>"><?php echo ucfirst(__('biography','szgoogleadmin')) ?>:</label></td>
	<td colspan="2" class="sz-cell-vals">
		<select class="widefat" id="<?php echo $ID_biography ?>" name="<?php echo $NAME_biography ?>">
			<option value="1" <?php echo selected("1",$VALUE_biography) ?>><?php echo __('profile','szgoogleadmin') ?></option>
			<option value="2" <?php echo selected("2",$VALUE_biography) ?>><?php echo __('author tagline','szgoogleadmin') ?></option>
			<option value="N" <?php echo selected("N",$VALUE_biography) ?>><?php echo __('none','szgoogleadmin') ?></option>
		</select>
	</td>
</tr>
