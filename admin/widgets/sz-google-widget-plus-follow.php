...
<tr class="sz-google-switch-url"><td colspan="2">
	<input class="sz-upload-image-url widefat" id="<?php echo $ID_url ?>" name="<?php echo $NAME_url ?>" type="text" value="<?php echo $VALUE_url ?>" placeholder="<?php echo __('insert URL for page or profile','szgoogleadmin') ?>"/>
</td></tr>
