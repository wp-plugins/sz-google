...
<tr>
	<td colspan="1" class="sz-cell-keys"><label for="<?php echo $ID_author ?>"><?php echo ucfirst(__('author','szgoogleadmin')) ?>:</label></td>
	<td colspan="1" class="sz-cell-vals"><input type="radio" name="<?php echo $NAME_author ?>" value="true"  <?php if ($VALUE_author == 'true') echo ' checked'?>>&nbsp;<?php echo ucfirst(__('enabled','szgoogleadmin')) ?></td>
	<td colspan="1" class="sz-cell-vals"><input type="radio" name="<?php echo $NAME_author ?>" value="false" <?php if ($VALUE_author != 'true') echo ' checked'?>>&nbsp;<?php echo ucfirst(__('disabled','szgoogleadmin')) ?></td>
</tr>
