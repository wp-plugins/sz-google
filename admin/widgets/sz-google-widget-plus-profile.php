...
<tr>
	...
	<td><input type="radio" name="<?php echo $NAME_author ?>" value="true"  <?php if ($VALUE_author == 'true') echo ' checked'?>>&nbsp;<?php echo ucfirst(__('enabled','szgoogleadmin')) ?></td>
	<td><input type="radio" name="<?php echo $NAME_author ?>" value="false" <?php if ($VALUE_author != 'true') echo ' checked'?>>&nbsp;<?php echo ucfirst(__('disabled','szgoogleadmin')) ?></td>
</tr>
