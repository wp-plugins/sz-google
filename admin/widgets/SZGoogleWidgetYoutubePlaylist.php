...
<tr>
	...
	<td colspan="1" class="sz-cell-vals"><input  id="<?php echo $ID_width ?>" class="sz-google-checks-width widefat" name="<?php echo $NAME_width ?>" type="text" placeholder="auto" value="<?php echo $VALUE_width ?>"/></td>
...
<tr>
	...
	<td colspan="1" class="sz-cell-vals"><input  id="<?php echo $ID_height ?>" class="sz-google-checks-height widefat" name="<?php echo $NAME_height ?>" type="text" placeholder="auto" value="<?php echo $VALUE_height ?>"/></td>
