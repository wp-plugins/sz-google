...
<tr>
	<td><label for="<?php echo $ID_set ?>"><?php echo ucfirst(__('set','szgoogleadmin')) ?>:</label></td>
	<td colspan="2">
...
<tr>
	<td><label for="<?php echo $ID_columns ?>"><?php echo ucfirst(__('columns','szgoogleadmin')) ?>:</label></td>
	<td><input id="<?php echo $ID_columns ?>" name="<?php echo $NAME_columns ?>" type="number" size="5" step="1" min="1" max="100" value="<?php echo $VALUE_columns ?>"/></td>
</tr>

<tr>
	<td><label for="<?php echo $ID_rows ?>"><?php echo ucfirst(__('rows','szgoogleadmin')) ?>:</label></td>
	<td><input id="<?php echo $ID_rows ?>" name="<?php echo $NAME_rows ?>" type="number" size="5" step="1" min="1" max="100" value="<?php echo $VALUE_rows ?>"/></td>
</tr>
...
<tr>
	<td><label for="<?php echo $ID_orientation ?>"><?php echo ucfirst(__('orientation','szgoogleadmin')) ?>:</label></td>
	<td colspan="2">
...
<tr>
	<td><label for="<?php echo $ID_position ?>"><?php echo ucfirst(__('position','szgoogleadmin')) ?>:</label></td>
	<td colspan="2">
