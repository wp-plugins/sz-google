...
code similar to the following, where the function is used <b>szgoogle_get_ga_ID()</b>.</p>
...
PHP function PHP <b>szgoogle_get_ga_code()</b> and insert it into the precise point that we wish to.</p>
