...
<p>In this picture you can see the end result of this feature. Displays a sample document present in google drive through the 
shortcode used in the "shortcode example" with set option type="document".</p>
