	...
	class SZGoogleAdminYoutube extends SZGoogleAdmin
	{
		...
		function moduleAddFields()
		{
			...
			$this->sectionsfields = array(
				'01' => array(array('field' => 'youtube_channel'           ,'title' => ucfirst(__('channel name or ID'        ,'szgoogleadmin')),'callback' => array($this,'callback_youtube_channel')),),
				'02' => array(array('field' => 'youtube_force_ssl'         ,'title' => ucfirst(__('force SSL'                 ,'szgoogleadmin')),'callback' => array($this,'callback_youtube_force_ssl')),
				              array('field' => 'youtube_fullscreen'        ,'title' => ucfirst(__('enable fullscreen'         ,'szgoogleadmin')),'callback' => array($this,'callback_youtube_fullscreen')),
				              array('field' => 'youtube_disablekeyboard'   ,'title' => ucfirst(__('disable keyboard'          ,'szgoogleadmin')),'callback' => array($this,'callback_youtube_disablekeyboard')),
				              array('field' => 'youtube_disableiframe'     ,'title' => ucfirst(__('disable IFRAME and use API','szgoogleadmin')),'callback' => array($this,'callback_youtube_disableiframe')),
				              array('field' => 'youtube_analytics'         ,'title' => ucfirst(__('google analytics'          ,'szgoogleadmin')),'callback' => array($this,'callback_youtube_analytics')),
				              array('field' => 'youtube_delayed'           ,'title' => ucfirst(__('delayed loading'           ,'szgoogleadmin')),'callback' => array($this,'callback_youtube_delayed')),
				              array('field' => 'youtube_disablerelated'    ,'title' => ucfirst(__('disable related'           ,'szgoogleadmin')),'callback' => array($this,'callback_youtube_disablerelated')),),
				'03' => array(array('field' => 'youtube_shortcode'         ,'title' => ucfirst(__('youtube video'             ,'szgoogleadmin')),'callback' => array($this,'callback_youtube_shortcode')),
				              array('field' => 'youtube_shortcode_badge'   ,'title' => ucfirst(__('youtube badge'             ,'szgoogleadmin')),'callback' => array($this,'callback_youtube_shortcode_badge')),
				              array('field' => 'youtube_shortcode_button'  ,'title' => ucfirst(__('youtube button'            ,'szgoogleadmin')),'callback' => array($this,'callback_youtube_shortcode_button')),
				              array('field' => 'youtube_shortcode_link'    ,'title' => ucfirst(__('youtube link'              ,'szgoogleadmin')),'callback' => array($this,'callback_youtube_shortcode_link')),
				              array('field' => 'youtube_shortcode_playlist','title' => ucfirst(__('youtube playlist'          ,'szgoogleadmin')),'callback' => array($this,'callback_youtube_shortcode_playlist')),),
				'04' => array(array('field' => 'youtube_widget'            ,'title' => ucfirst(__('youtube video'             ,'szgoogleadmin')),'callback' => array($this,'callback_youtube_widget')),
				              array('field' => 'youtube_widget_badge'      ,'title' => ucfirst(__('youtube badge'             ,'szgoogleadmin')),'callback' => array($this,'callback_youtube_widget_badge')),				              
				              array('field' => 'youtube_widget_button'     ,'title' => ucfirst(__('youtube button'            ,'szgoogleadmin')),'callback' => array($this,'callback_youtube_widget_button')),
				              array('field' => 'youtube_widget_link'       ,'title' => ucfirst(__('youtube link'              ,'szgoogleadmin')),'callback' => array($this,'callback_youtube_widget_link')),
				              array('field' => 'youtube_widget_playlist'   ,'title' => ucfirst(__('youtube playlist'          ,'szgoogleadmin')),'callback' => array($this,'callback_youtube_widget_playlist')),),
				'05' => array(array('field' => 'youtube_responsive'        ,'title' => ucfirst(__('responsive mode'           ,'szgoogleadmin')),'callback' => array($this,'callback_youtube_responsive')),
				              array('field' => 'youtube_width'             ,'title' => ucfirst(__('default width'             ,'szgoogleadmin')),'callback' => array($this,'callback_youtube_width')),
				              array('field' => 'youtube_height'            ,'title' => ucfirst(__('default height'            ,'szgoogleadmin')),'callback' => array($this,'callback_youtube_height')),
				              array('field' => 'youtube_autoplay'          ,'title' => ucfirst(__('video autoplay'            ,'szgoogleadmin')),'callback' => array($this,'callback_youtube_autoplay')),
				              array('field' => 'youtube_loop'              ,'title' => ucfirst(__('video loop'                ,'szgoogleadmin')),'callback' => array($this,'callback_youtube_loop')),
				              array('field' => 'youtube_theme'             ,'title' => ucfirst(__('theme'                     ,'szgoogleadmin')),'callback' => array($this,'callback_youtube_theme')),
				              array('field' => 'youtube_cover'             ,'title' => ucfirst(__('cover'                     ,'szgoogleadmin')),'callback' => array($this,'callback_youtube_cover')),
				              array('field' => 'youtube_schemaorg'         ,'title' => ucfirst(__('schema.org'                ,'szgoogleadmin')),'callback' => array($this,'callback_youtube_schemaorg')),),
				'06' => array(array('field' => 'youtube_margin_top'        ,'title' => ucfirst(__('margin top'                ,'szgoogleadmin')),'callback' => array($this,'callback_youtube_margin_top')),
				              array('field' => 'youtube_margin_right'      ,'title' => ucfirst(__('margin right'              ,'szgoogleadmin')),'callback' => array($this,'callback_youtube_margin_right')),
				              array('field' => 'youtube_margin_bottom'     ,'title' => ucfirst(__('margin bottom'             ,'szgoogleadmin')),'callback' => array($this,'callback_youtube_margin_bottom')),
				              array('field' => 'youtube_margin_left'       ,'title' => ucfirst(__('margin left'               ,'szgoogleadmin')),'callback' => array($this,'callback_youtube_margin_left')),
				              array('field' => 'youtube_margin_unit'       ,'title' => ucfirst(__('margin unit'               ,'szgoogleadmin')),'callback' => array($this,'callback_youtube_margin_unit')),),
			);
