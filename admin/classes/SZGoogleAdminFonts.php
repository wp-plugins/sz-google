	...
	class SZGoogleAdminFonts extends SZGoogleAdmin
	{
		...
		function moduleAddFields()
		{
			...
			$this->sectionsfields = array(
				'01' => array(array('field' => 'fonts_tinyMCE_F','title' => ucfirst(__('tinyMCE Font Family','szgoogleadmin'))                                  ,'callback' => array($this,'callback_fonts_tinymce_f')),
				              array('field' => 'fonts_tinyMCE_S','title' => ucfirst(__('tinyMCE Font Size'  ,'szgoogleadmin'))                                  ,'callback' => array($this,'callback_fonts_tinymce_s')),),
				'02' => array(array('field' => 'fonts_family_L1','title' => ucfirst(__('font family'        ,'szgoogleadmin'))                                  ,'callback' => array($this,'callback_fonts_family_L1')),
				              array('field' => 'fonts_family_L2','title' => ucfirst(__('font family'        ,'szgoogleadmin'))                                  ,'callback' => array($this,'callback_fonts_family_L2')),
				              array('field' => 'fonts_family_L3','title' => ucfirst(__('font family'        ,'szgoogleadmin'))                                  ,'callback' => array($this,'callback_fonts_family_L3')),
				              array('field' => 'fonts_family_L4','title' => ucfirst(__('font family'        ,'szgoogleadmin'))                                  ,'callback' => array($this,'callback_fonts_family_L4')),
				              array('field' => 'fonts_family_L5','title' => ucfirst(__('font family'        ,'szgoogleadmin'))                                  ,'callback' => array($this,'callback_fonts_family_L5')),
				              array('field' => 'fonts_family_L6','title' => ucfirst(__('font family'        ,'szgoogleadmin'))                                  ,'callback' => array($this,'callback_fonts_family_L6')),),
				'03' => array(array('field' => 'fonts_family_B1','title' => ucfirst(__('font family'        ,'szgoogleadmin').htmlspecialchars(' <body>'))      ,'callback' => array($this,'callback_fonts_family_B1')),
				              array('field' => 'fonts_family_P1','title' => ucfirst(__('font family'        ,'szgoogleadmin').htmlspecialchars(' <p>'))         ,'callback' => array($this,'callback_fonts_family_P1')),
				              array('field' => 'fonts_family_B2','title' => ucfirst(__('font family'        ,'szgoogleadmin').htmlspecialchars(' <blockquote>')),'callback' => array($this,'callback_fonts_family_B2')),),
				'04' => array(array('field' => 'fonts_family_H1','title' => ucfirst(__('font family'        ,'szgoogleadmin').htmlspecialchars(' <h1>'))        ,'callback' => array($this,'callback_fonts_family_H1')),
				              array('field' => 'fonts_family_H2','title' => ucfirst(__('font family'        ,'szgoogleadmin').htmlspecialchars(' <h2>'))        ,'callback' => array($this,'callback_fonts_family_H2')),
				              array('field' => 'fonts_family_H3','title' => ucfirst(__('font family'        ,'szgoogleadmin').htmlspecialchars(' <h3>'))        ,'callback' => array($this,'callback_fonts_family_H3')),
				              array('field' => 'fonts_family_H4','title' => ucfirst(__('font family'        ,'szgoogleadmin').htmlspecialchars(' <h4>'))        ,'callback' => array($this,'callback_fonts_family_H4')),
				              array('field' => 'fonts_family_H5','title' => ucfirst(__('font family'        ,'szgoogleadmin').htmlspecialchars(' <h5>'))        ,'callback' => array($this,'callback_fonts_family_H5')),
				              array('field' => 'fonts_family_H6','title' => ucfirst(__('font family'        ,'szgoogleadmin').htmlspecialchars(' <h6>'))        ,'callback' => array($this,'callback_fonts_family_H6')),),
			);
