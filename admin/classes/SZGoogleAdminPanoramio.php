	...
	class SZGoogleAdminPanoramio extends SZGoogleAdmin
	{
		...
		function moduleAddFields()
		{
			...
			$this->sectionsfields = array(
				'01' => array(array('field' => 'panoramio_shortcode'    ,'title' => ucfirst(__('shortcode'          ,'szgoogleadmin')),'callback' => array($this,'callback_panoramio_shortcode')),),
				'02' => array(array('field' => 'panoramio_s_template'   ,'title' => ucfirst(__('default template'   ,'szgoogleadmin')),'callback' => array($this,'callback_panoramio_s_template')),
				              array('field' => 'panoramio_s_width'      ,'title' => ucfirst(__('default width'      ,'szgoogleadmin')),'callback' => array($this,'callback_panoramio_s_width')),
				              array('field' => 'panoramio_s_height'     ,'title' => ucfirst(__('default height'     ,'szgoogleadmin')),'callback' => array($this,'callback_panoramio_s_height')),
				              array('field' => 'panoramio_s_orientation','title' => ucfirst(__('default orientation','szgoogleadmin')),'callback' => array($this,'callback_panoramio_s_orientation')),
				              array('field' => 'panoramio_s_list_size'  ,'title' => ucfirst(__('default list size'  ,'szgoogleadmin')),'callback' => array($this,'callback_panoramio_s_list_size')),
				              array('field' => 'panoramio_s_position'   ,'title' => ucfirst(__('default position'   ,'szgoogleadmin')),'callback' => array($this,'callback_panoramio_s_position')),
				              array('field' => 'panoramio_s_paragraph'  ,'title' => ucfirst(__('enable paragraph'   ,'szgoogleadmin')),'callback' => array($this,'callback_panoramio_s_paragraph')),),
				'03' => array(array('field' => 'panoramio_widget'       ,'title' => ucfirst(__('widget'             ,'szgoogleadmin')),'callback' => array($this,'callback_panoramio_widget')),),
				'04' => array(array('field' => 'panoramio_w_template'   ,'title' => ucfirst(__('default template'   ,'szgoogleadmin')),'callback' => array($this,'callback_panoramio_w_template')),
				              array('field' => 'panoramio_w_width'      ,'title' => ucfirst(__('default width'      ,'szgoogleadmin')),'callback' => array($this,'callback_panoramio_w_width')),
				              array('field' => 'panoramio_w_height'     ,'title' => ucfirst(__('default height'     ,'szgoogleadmin')),'callback' => array($this,'callback_panoramio_w_height')),
				              array('field' => 'panoramio_w_orientation','title' => ucfirst(__('default orientation','szgoogleadmin')),'callback' => array($this,'callback_panoramio_w_orientation')),
				              array('field' => 'panoramio_w_list_size'  ,'title' => ucfirst(__('default list size'  ,'szgoogleadmin')),'callback' => array($this,'callback_panoramio_w_list_size')),
				              array('field' => 'panoramio_w_position'   ,'title' => ucfirst(__('default position'   ,'szgoogleadmin')),'callback' => array($this,'callback_panoramio_w_position')),),
			);
