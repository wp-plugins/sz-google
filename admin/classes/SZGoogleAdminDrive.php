	...
	class SZGoogleAdminDrive extends SZGoogleAdmin
	{
		...
		function moduleAddFields()
		{
			...
			$this->sectionsfields = array(
				'01' => array(array('field' => 'drive_sitename'            ,'title' => ucfirst(__('site name'          ,'szgoogleadmin')),'callback' => array($this,'callback_drive_sitename')),),
				'02' => array(array('field' => 'drive_savebutton_shortcode','title' => ucfirst(__('shortcode'          ,'szgoogleadmin')),'callback' => array($this,'callback_drive_savebutton_shortcode')),
				              array('field' => 'drive_savebutton_widget'   ,'title' => ucfirst(__('widget'             ,'szgoogleadmin')),'callback' => array($this,'callback_drive_savebutton_widget')),),
				'03' => array(array('field' => 'drive_embed_shortcode'     ,'title' => ucfirst(__('shortcode'          ,'szgoogleadmin')),'callback' => array($this,'callback_drive_embed_shortcode')),
				              array('field' => 'drive_embed_s_width'       ,'title' => ucfirst(__('default width'      ,'szgoogleadmin')),'callback' => array($this,'callback_drive_embed_s_width')),
				              array('field' => 'drive_embed_s_height'      ,'title' => ucfirst(__('default height'     ,'szgoogleadmin')),'callback' => array($this,'callback_drive_embed_s_height')),
				              array('field' => 'drive_embed_s_height_p'    ,'title' => ucfirst(__('presentation height','szgoogleadmin')),'callback' => array($this,'callback_drive_embed_s_height_p')),
				              array('field' => 'drive_embed_s_height_v'    ,'title' => ucfirst(__('video height'       ,'szgoogleadmin')),'callback' => array($this,'callback_drive_embed_s_height_v')),),
				'04' => array(array('field' => 'drive_embed_widget'        ,'title' => ucfirst(__('widget'             ,'szgoogleadmin')),'callback' => array($this,'callback_drive_embed_widget')),
				              array('field' => 'drive_embed_w_width'       ,'title' => ucfirst(__('default width'      ,'szgoogleadmin')),'callback' => array($this,'callback_drive_embed_w_width')),
				              array('field' => 'drive_embed_w_height'      ,'title' => ucfirst(__('default height'     ,'szgoogleadmin')),'callback' => array($this,'callback_drive_embed_w_height')),
				              array('field' => 'drive_embed_w_height_p'    ,'title' => ucfirst(__('presentation height','szgoogleadmin')),'callback' => array($this,'callback_drive_embed_w_height_p')),
				              array('field' => 'drive_embed_w_height_v'    ,'title' => ucfirst(__('video height'       ,'szgoogleadmin')),'callback' => array($this,'callback_drive_embed_w_height_v')),),
				'05' => array(array('field' => 'drive_viewer_shortcode'    ,'title' => ucfirst(__('shortcode'          ,'szgoogleadmin')),'callback' => array($this,'callback_drive_viewer_shortcode')),
				              array('field' => 'drive_viewer_s_width'      ,'title' => ucfirst(__('default width'      ,'szgoogleadmin')),'callback' => array($this,'callback_drive_viewer_s_width')),
				              array('field' => 'drive_viewer_s_height'     ,'title' => ucfirst(__('default height'     ,'szgoogleadmin')),'callback' => array($this,'callback_drive_viewer_s_height')),
				              array('field' => 'drive_viewer_s_t_position' ,'title' => ucfirst(__('title position'     ,'szgoogleadmin')),'callback' => array($this,'callback_drive_viewer_s_t_position')),
				              array('field' => 'drive_viewer_s_t_align'    ,'title' => ucfirst(__('title alignment'    ,'szgoogleadmin')),'callback' => array($this,'callback_drive_viewer_s_t_align')),),
				'06' => array(array('field' => 'drive_viewer_widget'       ,'title' => ucfirst(__('widget'             ,'szgoogleadmin')),'callback' => array($this,'callback_drive_viewer_widget')),
				              array('field' => 'drive_viewer_w_width'      ,'title' => ucfirst(__('default width'      ,'szgoogleadmin')),'callback' => array($this,'callback_drive_viewer_w_width')),
				              array('field' => 'drive_viewer_w_height'     ,'title' => ucfirst(__('default height'     ,'szgoogleadmin')),'callback' => array($this,'callback_drive_viewer_w_height')),
				              array('field' => 'drive_viewer_w_t_position' ,'title' => ucfirst(__('title position'     ,'szgoogleadmin')),'callback' => array($this,'callback_drive_viewer_w_t_position')),
				              array('field' => 'drive_viewer_w_t_align'    ,'title' => ucfirst(__('title alignment'    ,'szgoogleadmin')),'callback' => array($this,'callback_drive_viewer_w_t_align')),),
			);
