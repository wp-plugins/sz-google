	...
	class SZGoogleAdminBase extends SZGoogleAdmin
	{
		...
		function moduleAddFields()
		{
			...
			$this->sectionsfields = array(
				'01' => array(array('field' => 'plus'             ,'title' => ucwords(__('google+'             ,'szgoogleadmin')),'callback' => array($this,'callback_base_plus')),
				              array('field' => 'analytics'        ,'title' => ucwords(__('google analytics'    ,'szgoogleadmin')),'callback' => array($this,'callback_base_analytics')),
				              array('field' => 'authenticator'    ,'title' => ucwords(__('google authenticator','szgoogleadmin')),'callback' => array($this,'callback_base_authenticator')),
				              array('field' => 'calendar'         ,'title' => ucwords(__('google calendar'     ,'szgoogleadmin')),'callback' => array($this,'callback_base_calendar')),
				              array('field' => 'drive'            ,'title' => ucwords(__('google drive'        ,'szgoogleadmin')),'callback' => array($this,'callback_base_drive')),
				              ...
				              array('field' => 'tinymce'          ,'title' => ucwords(__('tinyMCE shortcodes'  ,'szgoogleadmin')),'callback' => array($this,'callback_base_tinymce')),),
				'02' => array(array('field' => 'API_enable'       ,'title' => ucwords(__('API enable'          ,'szgoogleadmin')),'callback' => array($this,'callback_base_api_enable')),
				            //array('field' => 'API_client_ID'    ,'title' => ucwords(__('API Client ID'       ,'szgoogleadmin')),'callback' => array($this,'callback_base_api_client_id')),
				            //array('field' => 'API_client_secret','title' => ucwords(__('API Client secret'   ,'szgoogleadmin')),'callback' => array($this,'callback_base_api_client_secret')),
				),
			);
...
/* SE 22222222222222222222 */
		...
		function callback_base_maps() 
		{
			...
			$this->moduleCommonFormDescription(__('activating this module you can use the google maps and put them in an article or in a widget on the sidebar of wordpress. Read the documentation to learn about all the configuration options and the features available.','szgoogleadmin'));
		}
