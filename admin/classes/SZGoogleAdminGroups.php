	...
	class SZGoogleAdminGroups extends SZGoogleAdmin
	{
		...
		function moduleAddFields()
		{
			...
			$this->sectionsfields = array(
				'01' => array(array('field' => 'groups_language' ,'title' => ucfirst(__('default language','szgoogleadmin')),'callback' => array($this,'callback_groups_language')),),
				'02' => array(array('field' => 'groups_shortcode','title' => ucfirst(__('shortcode'       ,'szgoogleadmin')),'callback' => array($this,'callback_groups_shortcode')),
				              array('field' => 'groups_widget'   ,'title' => ucfirst(__('widget'          ,'szgoogleadmin')),'callback' => array($this,'callback_groups_widget')),),
				'03' => array(array('field' => 'groups_name'       ,'title' => ucfirst(__('group name'    ,'szgoogleadmin')),'callback' => array($this,'callback_groups_name')),
				              array('field' => 'groups_showsearch' ,'title' => ucfirst(__('show search'   ,'szgoogleadmin')),'callback' => array($this,'callback_groups_showsearch')),
				              array('field' => 'groups_showtabs'   ,'title' => ucfirst(__('show tabs'     ,'szgoogleadmin')),'callback' => array($this,'callback_groups_showtabs')),
				              array('field' => 'groups_hidetitle'  ,'title' => ucfirst(__('hide title'    ,'szgoogleadmin')),'callback' => array($this,'callback_groups_hidetitle')),
				              array('field' => 'groups_hidesubject','title' => ucfirst(__('hide subject'  ,'szgoogleadmin')),'callback' => array($this,'callback_groups_hidesubject')),
				              array('field' => 'groups_width'      ,'title' => ucfirst(__('default width' ,'szgoogleadmin')),'callback' => array($this,'callback_groups_width')),
				              array('field' => 'groups_height'     ,'title' => ucfirst(__('default height','szgoogleadmin')),'callback' => array($this,'callback_groups_height')),),
			);
