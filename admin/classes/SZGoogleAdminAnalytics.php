...
if (!class_exists('SZGoogleAdminAnalytics'))
{
	class SZGoogleAdminAnalytics extends SZGoogleAdmin
	{
		...
		function moduleAddFields()
		{
			...
			$this->sectionsfields = array(
				'01' => array(array('field' => 'ga_uacode'                    ,'title' => ucwords(__('UA code'             ,'szgoogleadmin')),'callback' => array($this,'callback_analytics_uacode')),
				              ...
				              array('field' => 'ga_compression'               ,'title' => ucfirst(__('compression'         ,'szgoogleadmin')),'callback' => array($this,'callback_analytics_compression')),),
				...
				'03' => array(array('field' => 'ga_enable_subdomains'         ,'title' => ucfirst(__('tracking subdomains' ,'szgoogleadmin')),'callback' => array($this,'callback_analytics_enable_subdomains')),
				              ...
				              array('field' => 'ga_enable_cl_proxy'           ,'title' => ucfirst(__('Proxy HTTP'          ,'szgoogleadmin')),'callback' => array($this,'callback_analytics_enable_cl_proxy')),
				              array('field' => 'ga_enable_cl_proxy_url'       ,'title' => ucfirst(__('Proxy HTTP URL'      ,'szgoogleadmin')),'callback' => array($this,'callback_analytics_enable_cl_proxy_url')),
				              array('field' => 'ga_enable_cl_proxy_adv'       ,'title' => ucfirst(__('Proxy HTTP URL adv'  ,'szgoogleadmin')),'callback' => array($this,'callback_analytics_enable_cl_proxy_adv')),),
				'04' => array(array('field' => 'ga_enable_ip_none_ad'         ,'title' => ucfirst(__('IP Anonymization'    ,'szgoogleadmin')),'callback' => array($this,'callback_analytics_enable_ip_none_ad')),
				              ...
				              array('field' => 'ga_enable_un_proxy'           ,'title' => ucfirst(__('Proxy HTTP'          ,'szgoogleadmin')),'callback' => array($this,'callback_analytics_enable_un_proxy')),
				              array('field' => 'ga_enable_un_proxy_url'       ,'title' => ucfirst(__('Proxy HTTP URL'      ,'szgoogleadmin')),'callback' => array($this,'callback_analytics_enable_un_proxy_url')),),
			);
		...
		function callback_analytics_compression()
		{
			...
			$this->moduleCommonFormDescription(__('enable this option to compress the HTML code that is placed in the WEB page by the plugin. This option need to be current with those using an HTML minimized to create their own web pages. It works both for the header that footer.','szgoogleadmin'));
		}
		...
		function callback_analytics_enable_cl_proxy()
		{
			...
			$this->moduleCommonFormDescription(__('there may be situations where you want to make a proxy on request script google GA. For example, useful when you want to change the values ​​of Cache. Obviously the proxy configuration should be performed at the webserver like Apache.','szgoogleadmin'));
		}

		function callback_analytics_enable_cl_proxy_url()
		{
			$this->moduleCommonFormText('sz_google_options_ga','ga_enable_cl_proxy_url','large',__('insert URL as domain.com/URL dont\'use (http://)','szgoogleadmin'));
			$this->moduleCommonFormDescription(__('if you have enabled the HTTP Proxy can indicate the URL address on which to run the local operation PROXY. For example you can use domain.com/cache/ga.js to run the proxy on www.google-analytics.com/ga.js. Dont\'use prefix (http://).','szgoogleadmin'));
		}

		function callback_analytics_enable_cl_proxy_adv()
		{
			$this->moduleCommonFormText('sz_google_options_ga','ga_enable_cl_proxy_adv','large',__('insert URL as domain.com/URL dont\'use (http://)','szgoogleadmin'));
			$this->moduleCommonFormDescription(__('if you have enabled the HTTP Proxy can indicate the URL address on which to run the local operation PROXY. For example you can use domain.com/cache/advertiser.js to run the proxy on stats.g.doubleclick.net/dc.js. Dont\'use prefix (http://).','szgoogleadmin'));
		}
		...
		{
			$this->moduleCommonFormText('sz_google_options_ga','ga_enable_un_proxy_url','large',__('insert URL as domain.com/URL dont\'use (http://)','szgoogleadmin'));
			$this->moduleCommonFormDescription(__('if you have enabled the HTTP Proxy can indicate the URL address on which to run the local operation PROXY. For example you can use domain.com/cache/ga.js to run the proxy on www.google-analytics.com/analytics.js. Dont\'use prefix (http://).','szgoogleadmin'));
		}
	}
}