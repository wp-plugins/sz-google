	...
	class SZGoogleAdminPlus extends SZGoogleAdmin
	{
		...
		function moduleAddFields()
		{
			...
			$this->sectionsfields = array(
				'01' => array(array('field' => 'plus_profile'                     ,'title' => ucwords(__('google+ profile'        ,'szgoogleadmin')),'callback' => array($this,'callback_plus_profile')),
				              array('field' => 'plus_page'                        ,'title' => ucwords(__('google+ page'           ,'szgoogleadmin')),'callback' => array($this,'callback_plus_page')),
				              array('field' => 'plus_community'                   ,'title' => ucwords(__('google+ community'      ,'szgoogleadmin')),'callback' => array($this,'callback_plus_community')),),
				'02' => array(array('field' => 'plus_language'                    ,'title' => ucfirst(__('select language'        ,'szgoogleadmin')),'callback' => array($this,'callback_plus_language')),),
				'03' => array(array('field' => 'plus_redirect_sign'               ,'title' => ucfirst(__('redirect /+'            ,'szgoogleadmin')),'callback' => array($this,'callback_plus_redirect_sign')),
				              array('field' => 'plus_redirect_sign_url'           ,'title' => ucfirst(__('redirect /+ URL'        ,'szgoogleadmin')),'callback' => array($this,'callback_plus_redirect_sign_url')),
				              array('field' => 'plus_redirect_plus'               ,'title' => ucfirst(__('redirect /plus'         ,'szgoogleadmin')),'callback' => array($this,'callback_plus_redirect_plus')),
				              array('field' => 'plus_redirect_plus_url'           ,'title' => ucfirst(__('redirect /plus URL'     ,'szgoogleadmin')),'callback' => array($this,'callback_plus_redirect_plus_url')),
				              array('field' => 'plus_redirect_curl'               ,'title' => ucfirst(__('redirect URL'           ,'szgoogleadmin')),'callback' => array($this,'callback_plus_redirect_curl')),
				              array('field' => 'plus_redirect_curl_source'        ,'title' => ucfirst(__('redirect URL source'    ,'szgoogleadmin')),'callback' => array($this,'callback_plus_redirect_curl_source')),
				              array('field' => 'plus_redirect_curl_target'        ,'title' => ucfirst(__('redirect URL target'    ,'szgoogleadmin')),'callback' => array($this,'callback_plus_redirect_curl_target')),),
				'04' => array(array('field' => 'plus_enable_recommendations'      ,'title' => ucwords(__('recommendations mobile' ,'szgoogleadmin')),'callback' => array($this,'callback_plus_enable_recommendations')),
				              array('field' => 'plus_system_javascript'           ,'title' => ucwords(__('disable file javascript','szgoogleadmin')),'callback' => array($this,'callback_plus_system_javascript')),),
				'05' => array(array('field' => 'plus_shortcode_pr_enable'         ,'title' => ucwords(__('google+ profile'        ,'szgoogleadmin')),'callback' => array($this,'callback_plus_shortcode_profile')),
				              array('field' => 'plus_shortcode_pa_enable'         ,'title' => ucwords(__('google+ page'           ,'szgoogleadmin')),'callback' => array($this,'callback_plus_shortcode_page')),
				              array('field' => 'plus_shortcode_co_enable'         ,'title' => ucwords(__('google+ community'      ,'szgoogleadmin')),'callback' => array($this,'callback_plus_shortcode_community')),
				              array('field' => 'plus_shortcode_fl_enable'         ,'title' => ucwords(__('google+ followers'      ,'szgoogleadmin')),'callback' => array($this,'callback_plus_shortcode_followers')),
				              array('field' => 'plus_shortcode_size_portrait'     ,'title' => ucwords(__('width portrait'         ,'szgoogleadmin')),'callback' => array($this,'callback_plus_shortcode_size_portrait')),
				              array('field' => 'plus_shortcode_size_landscape'    ,'title' => ucwords(__('width landscape'        ,'szgoogleadmin')),'callback' => array($this,'callback_plus_shortcode_size_landscape')),),
				'06' => array(array('field' => 'plus_button_enable_plusone'       ,'title' => ucwords(__('google+ plusone'        ,'szgoogleadmin')),'callback' => array($this,'callback_plus_button_plusone')),
				              array('field' => 'plus_button_enable_sharing'       ,'title' => ucwords(__('google+ sharing'        ,'szgoogleadmin')),'callback' => array($this,'callback_plus_button_sharing')),
				              array('field' => 'plus_button_enable_follow'        ,'title' => ucwords(__('google+ follow'         ,'szgoogleadmin')),'callback' => array($this,'callback_plus_button_follow')),),
				'07' => array(array('field' => 'plus_post_enable_shortcode'       ,'title' => ucwords(__('google+ post'           ,'szgoogleadmin')),'callback' => array($this,'callback_plus_post_shortcode')),),
				'08' => array(array('field' => 'plus_widget_pr_enable'            ,'title' => ucwords(__('google+ profile'        ,'szgoogleadmin')),'callback' => array($this,'callback_plus_widget_profile')),
				              array('field' => 'plus_widget_pa_enable'            ,'title' => ucwords(__('google+ page'           ,'szgoogleadmin')),'callback' => array($this,'callback_plus_widget_page')),
				              array('field' => 'plus_widget_co_enable'            ,'title' => ucwords(__('google+ community'      ,'szgoogleadmin')),'callback' => array($this,'callback_plus_widget_community')),
				              array('field' => 'plus_widget_fl_enable'            ,'title' => ucwords(__('google+ followers'      ,'szgoogleadmin')),'callback' => array($this,'callback_plus_widget_followers')),
				              array('field' => 'plus_widget_size_portrait'        ,'title' => ucwords(__('width portrait'         ,'szgoogleadmin')),'callback' => array($this,'callback_plus_widget_size_portrait')),
				              array('field' => 'plus_widget_size_landscape'       ,'title' => ucwords(__('width landscape'        ,'szgoogleadmin')),'callback' => array($this,'callback_plus_widget_size_landscape')),),
				'09' => array(array('field' => 'plus_button_enable_widget_plusone','title' => ucwords(__('google+ plusone'        ,'szgoogleadmin')),'callback' => array($this,'callback_plus_widget_button_plusone')),
				              array('field' => 'plus_button_enable_widget_sharing','title' => ucwords(__('google+ sharing'        ,'szgoogleadmin')),'callback' => array($this,'callback_plus_widget_button_sharing')),
				              array('field' => 'plus_button_enable_widget_follow' ,'title' => ucwords(__('google+ follow'         ,'szgoogleadmin')),'callback' => array($this,'callback_plus_widget_button_follow')),),
				'10' => array(array('field' => 'plus_post_enable_widget'          ,'title' => ucwords(__('google+ post'           ,'szgoogleadmin')),'callback' => array($this,'callback_plus_post_widget')),),
				'11' => array(array('field' => 'plus_comments_gp_enable'          ,'title' => ucwords(__('g+ comments'            ,'szgoogleadmin')),'callback' => array($this,'callback_plus_comments_gp')),
				              array('field' => 'plus_comments_wp_enable'          ,'title' => ucwords(__('WP comments'            ,'szgoogleadmin')),'callback' => array($this,'callback_plus_comments_wp')),
				              array('field' => 'plus_comments_ac_enable'          ,'title' => ucwords(__('after content'          ,'szgoogleadmin')),'callback' => array($this,'callback_plus_comments_ac')),
				              array('field' => 'plus_comments_aw_enable'          ,'title' => ucwords(__('after WP system'        ,'szgoogleadmin')),'callback' => array($this,'callback_plus_comments_aw')),
				              array('field' => 'plus_comments_wd_enable'          ,'title' => ucwords(__('widget'                 ,'szgoogleadmin')),'callback' => array($this,'callback_plus_comments_wd')),
				              array('field' => 'plus_comments_sh_enable'          ,'title' => ucwords(__('shortcode'              ,'szgoogleadmin')),'callback' => array($this,'callback_plus_comments_sh')),
				              array('field' => 'plus_comments_dt_enable'          ,'title' => ucwords(__('date switch'            ,'szgoogleadmin')),'callback' => array($this,'callback_plus_comments_dt')),
				              array('field' => 'plus_comments_fixed_size'         ,'title' => ucwords(__('fixed size'             ,'szgoogleadmin')),'callback' => array($this,'callback_plus_comments_fixed_size')),
				              array('field' => 'plus_comments_title'              ,'title' => ucwords(__('title'                  ,'szgoogleadmin')),'callback' => array($this,'callback_plus_comments_title')),
				              array('field' => 'plus_comments_css_class_1'        ,'title' => ucwords(__('CSS class 1'            ,'szgoogleadmin')),'callback' => array($this,'callback_plus_comments_css_class_1')),
				              array('field' => 'plus_comments_css_class_2'        ,'title' => ucwords(__('CSS class 2'            ,'szgoogleadmin')),'callback' => array($this,'callback_plus_comments_css_class_2')),),
				'12' => array(array('field' => 'plus_enable_author'               ,'title' => ucwords(__('HEAD Author'            ,'szgoogleadmin')),'callback' => array($this,'callback_plus_enable_author')),
				              array('field' => 'plus_enable_publisher'            ,'title' => ucwords(__('HEAD Publisher'         ,'szgoogleadmin')),'callback' => array($this,'callback_plus_enable_publisher')),),
				'13' => array(array('field' => 'plus_usercontact_page'            ,'title' => ucwords(__('google+ page'           ,'szgoogleadmin')),'callback' => array($this,'callback_plus_usercontact_page')),
				              array('field' => 'plus_usercontact_community'       ,'title' => ucwords(__('google+ community'      ,'szgoogleadmin')),'callback' => array($this,'callback_plus_usercontact_community')),
				              array('field' => 'plus_usercontact_bestpost'        ,'title' => ucwords(__('google+ best post'      ,'szgoogleadmin')),'callback' => array($this,'callback_plus_usercontact_bestpost')),),
				'14' => array(array('field' => 'plus_author_badge'                ,'title' => ucwords(__('author badge'           ,'szgoogleadmin')),'callback' => array($this,'callback_plus_author_badge')),),
			);
