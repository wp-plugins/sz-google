	...
	class SZGoogleAdminTranslate extends SZGoogleAdmin
	{
		...
		function moduleAddFields()
		{
			...
			$this->sectionsfields = array(
				'01' => array(array('field' => 'translate_meta'        ,'title' => ucfirst(__('code META'          ,'szgoogleadmin')),'callback' => array($this,'callback_translate_meta')),
				              array('field' => 'translate_mode'        ,'title' => ucfirst(__('display mode'       ,'szgoogleadmin')),'callback' => array($this,'callback_translate_mode')),),
				'02' => array(array('field' => 'translate_language'    ,'title' => ucfirst(__('website language'   ,'szgoogleadmin')),'callback' => array($this,'callback_translate_language')),),
				'03' => array(array('field' => 'translate_shortcode'   ,'title' => ucfirst(__('shortcode'          ,'szgoogleadmin')),'callback' => array($this,'callback_translate_shortcode')),
				              array('field' => 'translate_widget'      ,'title' => ucfirst(__('widget'             ,'szgoogleadmin')),'callback' => array($this,'callback_translate_widget')),),
				'04' => array(array('field' => 'translate_automatic'   ,'title' => ucfirst(__('automatic banner'   ,'szgoogleadmin')),'callback' => array($this,'callback_translate_automatic')),
				              array('field' => 'translate_multiple'    ,'title' => ucfirst(__('multiple language'  ,'szgoogleadmin')),'callback' => array($this,'callback_translate_multiple')),
				              array('field' => 'translate_analytics'   ,'title' => ucwords(__('google analytics'   ,'szgoogleadmin')),'callback' => array($this,'callback_translate_analytics')),
				              array('field' => 'translate_analytics_ua','title' => ucwords(__('google analytics UA','szgoogleadmin')),'callback' => array($this,'callback_translate_analytics_ua')),),
			);
