...
define('SZ_PLUGIN_GOOGLE_PATH'    ,plugin_dir_url(SZ_PLUGIN_GOOGLE_MAIN));
define('SZ_PLUGIN_GOOGLE_BASENAME',dirname(SZ_PLUGIN_GOOGLE_MAIN));
define('SZ_PLUGIN_GOOGLE_BASENAMP',dirname(plugin_basename(SZ_PLUGIN_GOOGLE_MAIN)));

/**
 * Definizione delle costanti da usare nel plugin per uso generale,
 * qui vanno definite le costanti per le directory e i path.
 */
define('SZ_PLUGIN_GOOGLE_PATH_ADMIN_JS'           ,SZ_PLUGIN_GOOGLE_PATH.'admin/files/js/');
define('SZ_PLUGIN_GOOGLE_PATH_ADMIN_CSS'          ,SZ_PLUGIN_GOOGLE_PATH.'admin/files/css/');
define('SZ_PLUGIN_GOOGLE_PATH_ADMIN_IMAGES'       ,SZ_PLUGIN_GOOGLE_PATH.'admin/files/images/');

define('SZ_PLUGIN_GOOGLE_PATH_FRONT_JS'           ,SZ_PLUGIN_GOOGLE_PATH.'frontend/files/js/');
...
define('SZ_PLUGIN_GOOGLE_VALUE_ADMIN_SLUG','sz-google-admin.php');

define('SZ_PLUGIN_GOOGLE_VALUE_TEXT_MONTH_UPPER','MONTH');
define('SZ_PLUGIN_GOOGLE_VALUE_TEXT_SHORTCODE'  ,'shortcode');
define('SZ_PLUGIN_GOOGLE_VALUE_TEXT_TEMPLATE'   ,'template');
...
define('SZ_PLUGIN_GOOGLE_PLUS_ID_PROFILE'  ,'106189723444098348646');
...
define('SZ_PLUGIN_GOOGLE_PLUS_ID_COMMENTS_POST'    ,'comments-post');
define('SZ_PLUGIN_GOOGLE_PLUS_ID_COMMENTS_CONTENT' ,'comments-content');
define('SZ_PLUGIN_GOOGLE_PLUS_ID_COMMENTS_TEMPLATE','comments-template');

define('SZ_PLUGIN_GOOGLE_PLUS_CLASS_COMMENTS'      ,'comments-area');
...
define('SZ_PLUGIN_GOOGLE_DRIVE_EMBED_S_WIDTH'      ,SZ_PLUGIN_GOOGLE_VALUE_AUTO);
define('SZ_PLUGIN_GOOGLE_DRIVE_EMBED_S_HEIGHT'     ,SZ_PLUGIN_GOOGLE_VALUE_AUTO);
define('SZ_PLUGIN_GOOGLE_DRIVE_EMBED_W_WIDTH'      ,SZ_PLUGIN_GOOGLE_VALUE_AUTO);
define('SZ_PLUGIN_GOOGLE_DRIVE_EMBED_W_HEIGHT'     ,SZ_PLUGIN_GOOGLE_VALUE_AUTO);
define('SZ_PLUGIN_GOOGLE_DRIVE_VIEWER_S_WIDTH'     ,SZ_PLUGIN_GOOGLE_VALUE_AUTO);
define('SZ_PLUGIN_GOOGLE_DRIVE_VIEWER_S_HEIGHT'    ,SZ_PLUGIN_GOOGLE_VALUE_AUTO);
define('SZ_PLUGIN_GOOGLE_DRIVE_VIEWER_W_WIDTH'     ,SZ_PLUGIN_GOOGLE_VALUE_AUTO);
define('SZ_PLUGIN_GOOGLE_DRIVE_VIEWER_W_HEIGHT'    ,SZ_PLUGIN_GOOGLE_VALUE_AUTO);
