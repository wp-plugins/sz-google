...
if (!class_exists('SZGoogleModuleRecaptcha'))
{
	class SZGoogleModuleRecaptcha extends SZGoogleModule
	{
		...
		function addAdminNotices() 
		{
			...
			echo __('Google reCAPTCHA is suspended because it was found the file of emergency in the root directory.','szgoogleadmin');
			echo '</p></div>';
		}
		...
		{
			echo '<div class="error"><p>(<b>sz-google</b>) - ';
			echo __('Google reCAPTCHA is active but the keys are not valid.','szgoogleadmin');
			echo '</p></div>';
		}
