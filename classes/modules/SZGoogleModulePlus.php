	...
	class SZGoogleModulePlus extends SZGoogleModule
	{
		...
		function getOptions()
		{
			...
			$options = $this->checkOptionIsSet($options,array(
				...
				'plus_language'                     => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_widget_pr_enable'             => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_widget_pa_enable'             => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_widget_co_enable'             => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_widget_fl_enable'             => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_widget_size_portrait'         => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_widget_size_landscape'        => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_shortcode_pr_enable'          => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_shortcode_pa_enable'          => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_shortcode_co_enable'          => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_shortcode_fl_enable'          => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_shortcode_size_portrait'      => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_shortcode_size_landscape'     => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_button_enable_plusone'        => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_button_enable_sharing'        => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_button_enable_follow'         => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_button_enable_widget_plusone' => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_button_enable_widget_sharing' => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_button_enable_widget_follow'  => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_comments_sh_enable'           => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_comments_gp_enable'           => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_comments_gp_enable'           => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_comments_wp_enable'           => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_comments_ac_enable'           => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_comments_aw_enable'           => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_comments_dt_enable'           => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_comments_dt_day'              => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_comments_dt_month'            => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_comments_dt_year'             => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				...
				'plus_redirect_sign'                => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_redirect_plus'                => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_redirect_curl'                => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_redirect_curl_dir'            => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_redirect_curl_url'            => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_redirect_flush'               => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_system_javascript'            => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_post_enable_widget'           => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_post_enable_shortcode'        => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_enable_author'                => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_enable_publisher'             => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_enable_recommendations'       => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_usercontact_page'             => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_usercontact_community'        => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'plus_usercontact_bestpost'         => SZ_PLUGIN_GOOGLE_VALUE_NULL,
			));
		...
		function moduleAddActions()
		{
			...
			if ($options['plus_comments_gp_enable'] == SZ_PLUGIN_GOOGLE_VALUE_YES) {
				add_action('init',array($this,'addPlusCommentsSystem'));
			}
		...
		function getPlusCommentsCode($atts=array(),$content=null) 
		{
			...
			if ($action == SZ_PLUGIN_GOOGLE_VALUE_TEXT_TEMPLATE) 
			{
				...
				$title = str_ireplace('{title}',ucfirst(SZGooglePluginCommon::getTranslate('leave a Reply')),$title);
			}
		 ...
		 * @return void
		 */
		function addPlusCommentsSystem() 
		{
			$options = $this->getOptions();
		...
		function addPlusCommentsSystemContent($content) 
		{
			...
			$HTML = $this->getPlusCommentsCode(array(
				'url'    => get_permalink(),
	...
	if (!function_exists('szgoogle_gplus_get_object')) {
		function szgoogle_gplus_get_object() { 
			if (!is_a(SZGoogleModule::$SZGoogleModulePlus,'SZGoogleModulePlus')) return false;
				else return SZGoogleModule::$SZGoogleModulePlus;
		}
	}
