...
if (!class_exists('SZGoogleModuleYoutube'))
{
	...
	class SZGoogleModuleYoutube extends SZGoogleModule
	{
		...
		function getOptions()
		{
			...
			$options = $this->checkOptionIsSet($options,array(
				'youtube_channel'            => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'youtube_widget'             => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'youtube_widget_badge'       => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'youtube_widget_playlist'    => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'youtube_shortcode'          => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'youtube_shortcode_badge'    => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'youtube_shortcode_button'   => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'youtube_shortcode_link'     => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'youtube_shortcode_playlist' => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'youtube_responsive'         => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'youtube_width'              => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'youtube_height'             => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'youtube_margin_top'         => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'youtube_margin_right'       => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'youtube_margin_bottom'      => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'youtube_margin_left'        => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'youtube_margin_unit'        => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'youtube_force_ssl'          => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'youtube_autoplay'           => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'youtube_loop'               => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'youtube_fullscreen'         => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'youtube_disablekeyboard'    => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'youtube_theme'              => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'youtube_cover'              => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'youtube_disableiframe'      => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'youtube_analytics'          => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'youtube_delayed'            => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'youtube_schemaorg'          => SZ_PLUGIN_GOOGLE_VALUE_NULL,
				'youtube_disablerelated'     => SZ_PLUGIN_GOOGLE_VALUE_NULL,
			));
		...
		function getYoutubeVideoCode($atts=array(),$content=null) 
		{
			...
			if ($vidID === false) 
			{
				...
				$HTML .= ucfirst(SZGooglePluginCommon::getTranslate('youtube URL string specified is not valid.'));
				$HTML .= '</div>';
				$HTML .= '</div>';
			...
			if ($name == SZ_PLUGIN_GOOGLE_VALUE_NULL) $NAME = esc_html(ucfirst(SZGooglePluginCommon::getTranslate('youtube video')));
		...
		function addYoutubeVideoAPI($opts=array())
		{
			if (is_array($opts)) {
				...
				add_action('szgoogle_footer',array($this,'addYoutubeScriptFooter'));
			}
		}
		...
		function getYoutubeLinkCode($atts=array(),$content=null) 
		{
			...
			if ($text         == SZ_PLUGIN_GOOGLE_VALUE_NULL) $text = SZGooglePluginCommon::getTranslate('channel youtube');
		...
		function getYoutubePlaylistCode($atts=array(),$content=null) 
		{
			...
			if ($id == SZ_PLUGIN_GOOGLE_VALUE_NULL) 
			{
				$HTML  = '<div class="sz-youtube-main" style="'.$CSS.'">';
				$HTML .= '<div class="sz-youtube-warn" style="display:block;padding:1em 0;text-align:center;background-color:#e1e1e1;border:1px solid #b1b1b1;">';
				$HTML .= ucfirst(SZGooglePluginCommon::getTranslate('youtube playlist ID is not valid.'));
				$HTML .= '</div>';
				$HTML .= '</div>';
	...
	if (!function_exists('szgoogle_youtube_get_object')) {
		function szgoogle_youtube_get_object() { 
			if (!is_a(SZGoogleModule::$SZGoogleModuleYoutube,'SZGoogleModuleYoutube')) return false;
				else return SZGoogleModule::$SZGoogleModuleYoutube;
		}
	}
