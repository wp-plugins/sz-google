...
if (!class_exists('SZGoogleModuleCalendar'))
{
	...
	class SZGoogleModuleCalendar extends SZGoogleModule
	{
		...
		function getCalendarEmbedCode($atts=array(),$content=null)
		{
			...
			if (!array_key_exists($language,SZGoogleCommon::getLanguages())) $language = SZ_PLUGIN_GOOGLE_VALUE_LANG;
			...
			if (!array_key_exists($timezone,SZGoogleCommon::getTimeZone())) $timezone = SZ_PLUGIN_GOOGLE_VALUE_NONE;
